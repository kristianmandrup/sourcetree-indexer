...
export class CodeSuggester {
  prompt =
    "Provide a bullet list of code improvement and refactor suggestions. Consider especially refactoring patterns like Extract method/class and Return early to break the code into smaller composable parts and avoid deep nesting.";
  ...
  protected async getCodeImprovementSuggestions(
    ...
    return await appContext.summarizer?.summarize(code);
  }
}
